...
export default function IpdBloodTestPage() {
  ...
  const singleTestComparisonData = useMemo(() => {
    ...
    // Get the latest test detail to maintain parameter ordering
    ...
    // Process parameters based on subheadings
    ...
    // Process remaining parameters not in subheadings
    orderedParams.forEach(p => addParameterRow(p, 0));
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gradient-to-r from-blue-600 to-blue-700 sticky top-0 z-10">
                        <tr>
                          ...
                          {singleTestComparisonData.selectedColumns.map((col, index) => (
